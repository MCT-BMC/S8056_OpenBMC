...
int8_t getSkuID()
{
    ...
    {
        std::cerr << "currentSku: S8056_GPU_SKU." << std::endl;
        skuType = S8056_GPU_SKU;
    }
    else
    {
        std::cerr << "currentSku: S8056_NON_GPU_SKU." << std::endl;
        skuType = S8056_NON_GPU_SKU;
    }
