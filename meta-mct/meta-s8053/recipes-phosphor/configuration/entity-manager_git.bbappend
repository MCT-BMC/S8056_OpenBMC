...
SRC_URI += "file://PDB-fru.json \
            file://s8053-Baseboard.json \
            file://s8053-DCSCM.json \
            file://s8053-Event-Sensor.json \
            file://s8053-PDB-node-1.json \
            file://s8053-PDB-node-2.json \
            file://s8053-Paddle-Card.json \
            file://s8053-Rear-Riser.json \
            file://s8053-Front-Riser.json \
            file://fan-table.json \
