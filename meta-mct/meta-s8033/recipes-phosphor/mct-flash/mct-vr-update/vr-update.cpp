...
int main(int argc, char *argv[])
{
    ...
    while ((option = getopt_long(argc, argv, short_options, long_options, NULL)) != (char) -1) {
        ...
        case 's':
            ...
            {
                case 1:
                    strcpy(vr.selectDevice, "P0_VDDIO_MEM_ABCD");
                    break;
                case 2:
                    strcpy(vr.selectDevice, "P0_VDDIO_MEM_EFGH");
                    break;
                case 3:
                    strcpy(vr.selectDevice, "P0_VDDCR_CPU");
                    break;
                case 4:
    ...
    if (devicesIt == supportedDevice.end())
    {
        ...
        std::cout << "  Supported IR device:\n";
        std::cout << "    01h - P0_VDDIO_MEM_ABCD\n";
        std::cout << "    02h - P0_VDDIO_MEM_EFGH\n";
        std::cout << "    03h - P0_VDDCR_CPU\n";
        std::cout << "    04h - P0_VDDCR_SOC\n";
        return -1;
    }
